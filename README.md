...
- <img src="https://shopgraph.dev/favicon.ico" height="14" alt="ShopGraph Logo" /> [ShopGraph](https://github.com/laundromatic/shopgraph) - Structured product data from the open web — Schema.org + AI extraction for e-commerce enrichment. Pay per call via Stripe. [shopgraph.dev](https://shopgraph.dev)
